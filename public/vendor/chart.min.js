...
!(function (t, e) {
  ...
  function L(t) {
    ...
    return (
      Array.isArray(t)
        ? t.length >= 3 &&
          ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = g(t[3])))
        : ((e = E(t, { r: 0, g: 0, b: 0, a: 1 })).a = g(e.a)),
      e
    )
  }
  function R(t) {
  ...
  class I {
    ...
    rgbString() {
      return this._valid
        ? (t = this._rgb) &&
            (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${p(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
        : this._rgb
      var t
    }
    hexString() {
      ...
      return this._valid
        ? (function (t) {
            ...
            const e = M(t),
              ...
              n = m(e[1]),
              o = m(e[2])
            return t.a < 255 ? `hsla(${i}, ${n}%, ${o}%, ${p(t.a)})` : `hsl(${i}, ${n}%, ${o}%)`
          })(this._rgb)
        : this._rgb
    }
    mix(t, e) {
    ...
    rotate(t) {
      return (
        (function (t, e) {
          var i = M(t)
          ;(i[0] = S(i[0] + e)), (i = k(i)), (t.r = i[0]), (t.g = i[1]), (t.b = i[2])
        })(this._rgb, t),
        this
      )
    }
  ...
  function B(t) {
    return z(t) ? t : F(t).saturate(0.5).darken(0.1).hexString()
  }
  function W() {}
  const H = (function () {
    let t = 0
  ...
  const Y = (t) => ('number' == typeof t || t instanceof Number) && isFinite(+t)
  function U(t, e) {
    return Y(t) ? t : e
  }
  function X(t, e) {
  ...
  const q = (t, e) => ('string' == typeof t && t.endsWith('%') ? parseFloat(t) / 100 : t / e),
    K = (t, e) => ('string' == typeof t && t.endsWith('%') ? (parseFloat(t) / 100) * e : +t)
  function G(t, e, i) {
  ...
  function ot(t, e, i) {
    ...
    const n = e[t],
      o = i[t]
    $(n) && $(o) ? nt(n, o) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = J(o))
  }
  function st(t, e) {
    const i = t.indexOf('.', e)
  ...
  function at(t, e) {
    ...
    let i = 0,
      n = st(e, i)
    for (; t && n > i; ) (t = t[e.substr(i, n - i)]), (i = n + 1), (n = st(e, i))
    return t
  }
  function rt(t) {
  ...
  function Oe(t) {
    ...
    if ($(t)) {
      const { x: s, y: a } = t
      ;(e = Ae(t.top, a)), (i = Ae(t.right, s)), (n = Ae(t.bottom, a)), (o = Ae(t.left, s))
    } else e = i = n = o = Ce(t)
  ...
  function $e(t, e, i) {
    ...
    for (o = 0, s = t.length, l = 0; o < s; ++o) {
      ;(a = t[o]), (r = a.box), r.update(a.width || e.w, a.height || e.h, je(a.horizontal, e))
  ...
  var Ue = {
    ...
    update(t, e, i, n) {
      if (!t) return
      const o = Ee(t.options.layout.padding),
        s = e - o.width,
        a = i - o.height,
        r = (function (t) {
          const e = (function (t) {
  ...
  class ri extends Xe {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e]
      if (!n) return
      ;(({ attach: si, detach: si, resize: si }[e] || Qe)(t, e, n), (i[e] = void 0))
    }
    getDevicePixelRatio() {
  ...
  var li = Object.freeze({ __proto__: null, BasePlatform: Xe, BasicPlatform: qe, DomPlatform: ri })
  const ci = (t) => 0 === t || 1 === t,
    ...
    ui = {
      ...
      easeInOutElastic(t) {
        const e = 0.1125
        return ci(t) ? t : t < 0.5 ? 0.5 * hi(2 * t, e, 0.45) : 0.5 + 0.5 * di(2 * t - 1, e, 0.45)
      },
      easeInBack(t) {
        const e = 1.70158
        return t * t * ((e + 1) * t - e)
  ...
  function yi(t, e, i, n) {
    ...
    if (null !== e) {
      for (a = 0, r = o.length; a < r; ++a) {
        ...
        ;(c = t.values[l]), Y(c) && (s || 0 === e || kt(e) === kt(c)) && (e += c)
      }
      return e
    }
  }
  ...
  class Ci {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let c, h, d, u
      for (c = 0, h = n; c < h; ++c)
        (d = c + i), (u = e[d]), (l[c] = { x: o.parse(at(u, a), d), y: s.parse(at(u, r), d) })
      return l
    }
    getParsed(t) {
    ...
    applyStack(t, e, i) {
      const n = this.chart,
        o = this._cachedMeta,
        s = e[t.axis]
      return yi({ keys: _i(n, !0), values: e._stacks[t.axis] }, s, o.index, { mode: i })
    }
    ...
    getMinMax(t, e) {
      ...
      let u, f, g, p
      function m() {
        return (g = o[u]), (f = g[t.axis]), (p = g[r.axis]), !Y(f) || h > p || d < p
      }
    ...
    getAllParsedValues(t) {
      const e = this._cachedMeta._parsed,
        i = []
      let n, o, s
      for (n = 0, o = e.length; n < o; ++n) (s = e[n][t.axis]), Y(s) && i.push(s)
      return i
    }
    getMaxOverflow() {
      return !1
    ...
    _update(t) {
      ...
      e.configure(),
        ...
        (i._clip = (function (t) {
          let e, i, n, o
          return (
            $(t) ? ((e = t.top), (i = t.right), (n = t.bottom), (o = t.left)) : (e = i = n = o = t),
    ...
    _resolveElementOptions(t, e = 'default', i) {
      ...
      return g.$shared && ((g.$shared = l), (s[a] = Object.freeze(Di(g, l)))), g
    }
  ...
  const Ei = {
    ...
    logarithmic: function (t, e, i) {
      ...
      return 1 === n || 2 === n || 5 === n ? Ei.numeric.call(this, t, e, i) : ''
    },
  }
  var Li = { formatters: Ei }
  ...
  class Hi extends Ai {
    ...
    calculateLabelRotation() {
      ...
      ;(a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r = t.maxHeight - zi(e.grid) - i.padding - Vi(e.title, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = Et(
            Math.min(
    ...
    _getLabelSizes() {
      ...
      if (!e) {
        ...
        let n = t.ticks
        i < n.length && (n = Ii(n, i)), (t._labelSizes = e = t._computeLabelSizes(n, n.length))
      }
      return e
    }
        ...
        if (
          ...
          if (j(c))
            for (r = 0, l = c.length; r < l; ++r)
              (m = c[r]), N(m) || j(m) || ((g = Nt(i, u.data, u.gc, g, m)), (p += f))
    ...
    drawGrid(t) {
      ...
      if (a) {
        ...
        let r, l, c, d
        e.isHorizontal()
          ? ((r = $t(o, e.left, a) - a / 2), (l = $t(o, e.right, n) + n / 2), (c = d = s))
          : ((c = $t(o, e.top, a) - a / 2), (d = $t(o, e.bottom, n) + n / 2), (r = l = s)),
    ...
    drawTitle() {
      ...
      'bottom' === e
        ? ((l += a.bottom), j(i.text) && (l += s.lineHeight * (i.text.length - 1)))
        : (l += a.top)
      const { titleX: c, titleY: h, maxWidth: d, rotation: u } = (function (t, e, i, o) {
        ...
        return (
          t.isHorizontal()
            ? ((h = n(o, a, l)), (d = Ri(t, i, e)), (c = l - a))
            : ((h = Ri(t, i, e)), (d = n(o, r, s)), (u = 'left' === i ? -yt : yt)),
      ...
      get: (i, n) =>
        Xi(i, n, () =>
          (function (t, e, i, n) {
            let o
            for (const s of e)
              if (((o = Ji(Yi(s, t), i)), lt(o))) return Ui(t, o) ? Zi(i, n, t, o) : o
          })(n, e, t, i),
        ),
          ...
          (function (t, e, i) {
            ...
            ct(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                r.add(t), (e = e(s, a || n)), r.delete(t), $(e) && (e = Zi(o._scopes, o, t, e))
                return e
              })(e, r, t, i))
            j(r) &&
              r.length &&
  ...
  const Ki = (t, e) => (!0 === t ? e : 'string' == typeof t ? at(e, t) : void 0)
  function Gi(t, e, i, n) {
    for (const o of e) {
      const e = Ki(i, o)
      if (e) {
  ...
  function sn(t) {
    ...
    for (o = 0; o < e; ++o)
      if (((s = a), (a = r), (r = nn(t, o + 1)), a)) {
        ...
        n[o] = s ? (r ? (kt(i[o - 1]) !== kt(i[o]) ? 0 : (i[o - 1] + i[o]) / 2) : i[o - 1]) : i[o]
      }
    !(function (t, e, i) {
      const n = t.length
      let o,
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = an(o.cp1x, e.left, e.right)), (o.cp1y = an(o.cp1y, e.top, e.bottom))),
              r && ((o.cp2x = an(o.cp2x, e.left, e.right)), (o.cp2y = an(o.cp2y, e.top, e.bottom))))
      })(t, i)
  }
  function ln(t, e, i, n) {
  ...
  function gn(t) {
    return 'angle' === t
      ? { between: Vt, compare: Ft, normalize: zt }
    ...
    register(t) {
      ...
      return (
        s in o ||
          ((o[s] = t),
          (function (t, e, i) {
            const n = it(Object.create(null), [i ? gt.get(i) : {}, gt.get(e), t.defaults])
            gt.set(e, n),
              t.defaultRoutes &&
                (function (t, e) {
      ...
      return !1 !== n || e
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = wn(i[r.id], n)
              null !== l && o.push({ plugin: r, options: kn(t.config, r, l, s) })
            }
            return o
          })(t, o, n, e)
        : []
        ...
        return (
          Object.keys(n).forEach((t) => {
            const e = n[t],
              ...
              c = i.scales || {}
            ;(s[r] = s[r] || t), (a[t] = nt(Object.create(null), [{ axis: r }, e, c[r], c[l]]))
          }),
          t.data.datasets.forEach((i) => {
            ...
            Object.keys(l).forEach((t) => {
              const e = (function (t, e) {
                ...
                o = i[e + 'AxisID'] || s[e] || e
              ;(a[o] = a[o] || Object.create(null)), nt(a[o], [{ axis: e }, n[o], l[t]])
            })
          }),
  ...
  class En {
    constructor(t) {
      ;(this._config = (function (t) {
        ...
        return (e.datasets = e.datasets || []), (e.labels = e.labels || []), Dn(t), t
      })(t)),
    ...
    resolveNamedOptions(t, e, i, n = ['']) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = Ln(this._resolverCache, t, n)
      let r = s
      if (
        (function (t, e) {
          const { isScriptable: i, isIndexable: n } = $i(t)
          for (const o of e) if ((i(o) && ct(t[o])) || (n(o) && j(t[o]))) return !0
          return !1
        })(s, e)
      ) {
        o.$shared = !1
    ...
    createResolver(t, e, i = [''], n) {
      const { resolver: o } = Ln(this._resolverCache, t, i)
  ...
  const Rn = ['top', 'bottom', 'left', 'right', 'chartArea']
  function In(t, e) {
    return 'top' === t || 'bottom' === t || (-1 === Rn.indexOf(t) && 'x' === e)
  }
  function Fn(t, e) {
    return function (i, n) {
  ...
  function Wn(t) {
    return (
      Bn() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class jn {
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Bn() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
        ? new qe()
        : new ri()
    }
    clear() {
      ...
      i &&
        ...
        Z(s, (i) => {
          ...
          if (a in n && n[a].type === l) c = n[a]
            ...
            ;(c = new (vn.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })), (n[c.id] = c)
          }
          c.init(s, e)
        }),
        Z(o, (t, e) => {
    ...
    _updateMetasets() {
      ...
      t._sortedMetasets = e.slice(0).sort(Fn('order', 'index'))
    }
    ...
    render() {
      ...
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (o.has(t) ? t.attached && !o.running(t) && o.start(t) : (t.draw(), zn({ chart: t })))
    }
    draw() {
      const t = this
      let e
  ...
  function Zn(t, e, i, n) {
    ...
    let c, h, d, u
    for (c = i, h = i + n; c < h; ++c)
      (u = e[c]), (d = {}), (d[o.axis] = r || o.parse(a[c], c)), l.push(Gn(u, d, s, c))
    return l
  }
  function Qn(t) {
  ...
  class Jn extends Ci {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g
      for (d = i, u = i + n; d < u; ++d)
        (g = e[d]), (f = {}), (f[o.axis] = o.parse(at(g, l), d)), h.push(Gn(at(g, c), f, s, d))
      return h
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        ...
        o = this.getParsed(t),
        s = o._custom,
        a = Qn(s) ? '[' + s.start + ', ' + s.end + ']' : '' + n.getLabelForValue(o[n.axis])
  ...
  class to extends Ci {
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (c = i, h = i + n; c < h; ++c)
        (d = e[c]),
          l.push({ x: o.parse(at(d, a), c), y: s.parse(at(d, r), c), _custom: d && d.r && +d.r })
      return l
    }
    getMaxOverflow() {
    ...
    resolveDataElementOptions(t, e) {
      ...
      const o = n.radius
      return 'active' !== e && (n.radius = 0), (n.radius += X(i && i._custom, o)), n
    }
  }
  ;(to.id = 'bubble'),
    (to.defaults = {
        ...
        { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = (function (t, e, i) {
          ...
          if (e < mt) {
            const r = t,
              ...
              g = (t, e, n) => (Vt(t, r, l) ? -1 : Math.min(e, e * i, n, n * i)),
              p = f(0, c, d),
              m = f(yt, h, u),
              x = g(pt, c, d),
              b = g(pt + yt, h, u)
    ...
    update(t) {
      ...
      let { start: r, count: l } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          d &&
            (o = Bt(
              Math.min(te(r, a.axis, c).lo, i ? n : te(e, l, a.getPixelForValue(c)).lo),
              0,
              n - 1,
            )),
            (s = u
              ? Bt(
                  Math.max(te(r, a.axis, h).hi + 1, i ? 0 : te(e, l, a.getPixelForValue(h)).hi + 1),
                  o,
                  n,
                ) - o
              : n - o)
  ...
  class oo extends eo {}
  ;(oo.id = 'pie'), (oo.defaults = { cutout: 0, rotation: 0, circumference: 360, radius: '100%' })
  class so extends Ci {
    getLabelAndValue(t) {
  ...
  ;(so.id = 'radar'),
    ...
    (so.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } })
  class ao extends io {}
  ;(ao.id = 'scatter'),
  ...
  function lo(t, e) {
    ...
    t.beginPath(),
      t.arc(s, a, r, i - c, n + c),
      l > o ? ((c = o / l), t.arc(s, a, l, n + c, i - c, !0)) : t.arc(s, a, o, n + yt, i - yt),
      t.closePath(),
      t.clip()
  }
  function co(t, e, i, n) {
        ...
        return (
          $(t)
            ? ((e = Ce(t.outerStart)),
              ...
              (o = Ce(t.innerEnd)))
            : (e = i = n = o = Ce(t)),
          { outerStart: e, outerEnd: i, innerStart: n, innerEnd: o }
        )
  ...
  function uo(t, e) {
    ...
    if (
      (t.beginPath(),
      t.arc(i, n, r, o + c.outerStart / (r - c.outerStart), s - c.outerEnd / (r - c.outerEnd)),
      0 !== c.outerEnd)
    ) {
      const e = ho(r - c.outerEnd, s - c.outerEnd / (r - c.outerEnd), i, n)
      t.arc(e.x, e.y, c.outerEnd, s - c.outerEnd / (r - c.outerEnd), s + yt)
    }
    const h = ho(l + c.innerEnd, s, i, n)
    if ((t.lineTo(h.x, h.y), 0 !== c.innerEnd)) {
      const e = ho(l + c.innerEnd, s - c.innerEnd / (l + c.innerEnd), i, n)
      t.arc(e.x, e.y, c.innerEnd, s + yt, s - c.innerEnd / (l + c.innerEnd) + Math.PI)
    }
    if ((t.arc(i, n, l, s - c.innerEnd / l, o + c.innerStart / l, !0), 0 !== c.innerStart)) {
      const e = ho(l + c.innerStart, o + c.innerStart / (l + c.innerStart), i, n)
      t.arc(e.x, e.y, c.innerStart, o + c.innerStart / (l + c.innerStart) + Math.PI, o - yt)
    }
    const d = ho(r - c.outerStart, o, i, n)
    if ((t.lineTo(d.x, d.y), 0 !== c.outerStart)) {
      const e = ho(r - c.outerStart, o + c.outerStart / (r - c.outerStart), i, n)
      t.arc(e.x, e.y, c.outerStart, o - yt, o + c.outerStart / (r - c.outerStart))
    }
    t.closePath()
  }
  function fo(t, e) {
        ...
        (function (t, e, i) {
          ...
          for (
            i &&
              ...
              lo(t, e),
              (e.endAngle = a),
              e.endAngle === e.startAngle && ((e.endAngle += mt), e.fullCircles--)),
              t.beginPath(),
            ...
            t.stroke()
          for (t.beginPath(), t.arc(n, o, l, s, s + mt), h = 0; h < e.fullCircles; ++h) t.stroke()
        })(t, e, n),
      n && lo(t, e),
      uo(t, e),
      t.stroke())
  ...
  class go extends Ai {
    ...
    inRange(t, e, i) {
      const n = this.getProps(['x', 'y'], i),
        { angle: o, distance: s } = Rt(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: r,
          innerRadius: l,
    ...
    draw(t) {
      ...
      if (
        ...
        ;(t.fillStyle = i.backgroundColor),
          ...
          (function (t, e) {
            if (e.fullCircles) {
              ;(e.endAngle = e.startAngle + mt), uo(t, e)
  ...
  function xo(t, e, i, n) {
    const { points: o, options: s } = e,
      ...
      h = (function (t) {
        return t.stepped ? Gt : t.tension ? Zt : po
      })(s)
    let d,
      u,
      f,
  ...
  function To(t, e) {
    ...
    t.arc(i + a.topLeft, n + a.topLeft, a.topLeft, -yt, pt, !0),
      ...
      t.arc(i + o - a.bottomRight, n + s - a.bottomRight, a.bottomRight, yt, 0, !0),
  ...
  class Lo extends Ai {
    ...
    draw(t) {
      const e = this.options,
        ...
        o = (s = n.radius).topLeft || s.topRight || s.bottomLeft || s.bottomRight ? To : Eo
      var s
      t.save(),
        (n.w === i.w && n.h === i.h) ||
          (t.beginPath(),
  ...
  ;(Lo.id = 'bar'),
    (Lo.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, pointStyle: void 0 }),
  ...
  class zo {
    ...
    pathSegment(t, e, i) {
      ...
      return (e = e || { start: 0, end: mt }), t.arc(n, o, s, e.end, e.start, !0), !i.bounds
    }
    interpolate(t) {
  ...
  function Vo(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          let l, c, h
          if (
            ((h = 'start' === i ? a : 'end' === i ? r : $(i) ? i.value : e.getBaseValue()),
            n.grid.circular)
          )
            return (
      ...
      : (function (t) {
          ...
          return (
            ...
            Y(o) ? ((n = e.isHorizontal()), { x: n ? o : null, y: n ? null : o }) : null
          )
        })(t)
  }
  function Bo(t) {
  ...
  function Uo(t, e, i, n) {
    ...
    let o = e[t],
      s = i[t]
    return 'angle' === t && ((o = zt(o)), (s = zt(s))), { property: t, start: o, end: s }
  }
  function Xo(t, e, i, n) {
  ...
  class Jo extends Ai {
    ...
    _draw() {
      const t = this,
        { options: e, columnSizes: i, lineWidths: o, ctx: s, legendHitBoxes: a } = t,
        { align: r, labels: l } = e,
        c = gt.color,
      ...
      ;(m = y
        ...
        : { x: t.left + f, y: n(r, t.top + v + f, t.bottom - i[0].height), line: 0 }),
      ...
      t.legendItems.forEach((e, u) => {
        ...
        h.setWidth(t.width),
          y
            ? u > 0 &&
              P + S + f > t.right &&
              ((D = m.y += M), m.line++, (P = m.x = n(r, t.left + f, t.right - o[m.line])))
            : u > 0 &&
              D + M > t.bottom &&
        ...
        !(function (t, e, i) {
          ...
          (a[u].top = D),
          (P = ((t, e, i) => ('right' === t ? i : 'center' === t ? (e + i) / 2 : e))(
            k,
            P + x + p,
            t.right,
          )),
          (function (t, e, i) {
            Qt(s, i.text, t, e + _ / 2, d, { strikethrough: i.hidden, textAlign: i.textAlign })
          })(h.x(P), D, e),
          y ? (m.x += S + f) : (m.y += M)
      }),
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        (g = Math.max(...t.lineWidths)), (u = t.top + d), (f = n(e.align, f, t.right - g))
      else {
        const i = t.columnSizes.reduce((t, e) => Math.max(t, e.height), 0)
        u = d + n(e.align, t.top, t.bottom - i - e.labels.padding - t._computeTitleHeight())
      }
      const p = n(c, f, f + g)
  ...
  class gs extends Ai {
    ...
    handleEvent(t, e) {
      ...
      return (
        ...
        s &&
          ((i._active = a),
          (n.enabled || n.external) && ((i._eventPosition = { x: t.x, y: t.y }), i.update(!0))),
        s
      )
    }
  ...
  class bs extends Hi {
    ...
    parse(t, e) {
      ...
      return isFinite(e) && i[e] === t ? e : xs(i, t, X(e, t))
    }
    determineDataLimits() {
      const t = this,
      ...
      const o = (function (t, e) {
        ...
        ;(_ = Math.ceil(u / y) - Math.floor(d / y)),
          ...
          f && g && n && At((s - o) / n, y / 1e3)
            ...
            : ((_ = (b - x) / y),
              (_ = Ct(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_))),
          (m = Math.pow(10, N(a) ? Lt(y) : a)),
          (x = Math.round(x * m) / m),
          (b = Math.round(b * m) / m)
        let v = 0
        for (
  ...
  class ys extends _s {
    determineDataLimits() {
      ...
      ;(t.min = Y(e) ? e : 0), (t.max = Y(i) ? i : 1), t.handleTickRangeOptions()
    }
    computeTickLimit() {
      const t = this
  ...
  ;(ys.id = 'linear'), (ys.defaults = { ticks: { callback: Li.formatters.numeric } })
  class Ms extends Hi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    configure() {
      const t = this,
        e = t.min
      super.configure(), (t._startValue = wt(e)), (t._valueRange = wt(t.max) - wt(e))
    }
    getPixelForValue(t) {
      const e = this
      return (
        (void 0 !== t && 0 !== t) || (t = e.min),
        e.getPixelForDecimal(t === e.min ? 0 : (wt(t) - e._startValue) / e._valueRange)
      )
    }
    getValueForPixel(t) {
      const e = this,
  ...
  ;(Ms.id = 'logarithmic'),
    (Ms.defaults = { ticks: { callback: Li.formatters.logarithmic, major: { enabled: !0 } } })
  class As extends _s {
    constructor(t) {
      super(t),
        (this.xCenter = void 0),
    ...
    getIndexAngle(t) {
      return zt(t * (mt / this.getLabels().length) + Tt(this.options.startAngle || 0))
    }
    ...
    drawBackground() {
      ...
      if (e) {
        ...
        n.save(),
          n.beginPath(),
          Ds(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
          n.closePath(),
          (n.fillStyle = e),
          n.fill(),
          n.restore()
  ...
  function Ls(t, e) {
    ...
    return (
      ...
      null === r
        ...
        : (s &&
            (r =
              'week' !== s || (!Dt(a) && !0 !== a) ? i.startOf(r, s) : i.startOf(r, 'isoWeek', a)),
          +r)
    )
  }
  function Rs(t, e, i, n) {
  ...
  class zs extends Hi {
    ...
    init(t, e) {
      ...
      nt(i.displayFormats, n.formats()), super.init(t), (this._normalized = e.normalized)
    }
    parse(t, e) {
  ...
  class Bs extends zs {
    ...
    getPixelForValue(t, e) {
      const i = this,
        n = i._offsets,
        o = i._normalized && i._maxIndex > 0 && !N(e) ? e / i._maxIndex : i.getDecimalForValue(t)
  ...
  return (
    ...
    (jn.Scale = Hi),
    (jn.Ticks = Li),
    Object.assign(jn, ro, Ws, Ro, ms, li),
    (jn.Chart = jn),
